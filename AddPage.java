 ...
 * and open the template in the editor.   dsdgdfgdfddgdf
 */
...
public class AddPage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           String fileName="prueba de GHIssues numero 2"; //request.getParameter("filename"); //esto es un comentario desde VSCode
